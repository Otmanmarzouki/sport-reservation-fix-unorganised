  ...
  return (
    <Container>
      <div className="flex flex-col w-full">
        <Header title="Taux d'occupation" className="text-2xl" />
          ...
          <ul className="flex">
            <li className="w-1/2">
              ...
              >
                ...
                <span className="text-base">Synthèse</span>
              </button>
            </li>
            <li className="w-1/2">
              <button
                onClick={() => setOpenTab(2)}
                className={`flex w-full py-2 p-2 justify-center items-center  bg-white shadow ${
                  openTab === 2 ? "border-b-2 border-orange-500 text-gray-900" : "text-gray-600"
                }`}
              >
                <HiChartPie className="text-2xl text-orange-500" />
                <span className="text-base">Détaille</span>
              </button>
            </li>
          </ul>
